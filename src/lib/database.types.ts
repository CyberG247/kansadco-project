...
export type Database = {
  public: {
    Tables: {
      ...
      testimonials: {
        Row: { id: string; quote: string; name: string; role: string; sort_order: number; status: "Published" | "Draft"; created_at: string; updated_at: string };
        Insert: { id?: string; quote: string; name: string; role: string; sort_order?: number; status?: "Published" | "Draft"; created_at?: string; updated_at?: string };
      ...
      activities: {
        Row: { id: string; message: string; type: "project" | "gallery" | "team" | "testimonial" | "enquiry" | "settings"; read: boolean; created_at: string; actor_id: string | null };
        Insert: { id?: string; message: string; type: "project" | "gallery" | "team" | "testimonial" | "enquiry" | "settings"; read?: boolean; created_at?: string; actor_id?: string | null };
        Update: { read?: boolean };
        Relationships: [];
      };
    };
