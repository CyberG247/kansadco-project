...
const About = () => (
  <>
    ...
    <section className="section-padding bg-background"><div className="container-custom grid gap-14 lg:grid-cols-12"><div className="lg:col-span-5"><div className="image-reveal aspect-[4/5]"><img src={chairman} alt="Arch. Yunusa Ibrahim Hassan, MNIA" className="h-full w-full object-cover object-top" /></div></div><div className="flex flex-col justify-center lg:col-span-6 lg:col-start-7"><p className="eyebrow mb-8 text-accent">Leadership</p><h2 className="section-title">Driving the vision <em className="text-accent">forward.</em></h2><p className="mt-9 max-w-xl text-sm leading-7 text-muted-foreground">Arch. Yunusa Ibrahim Hassan, MNIA founded KANSADCO around a commitment to vision, responsibility, professionalism and excellence. His approach is to understand each client's aspirations, transform ideas into purposeful spaces and build lasting relationships through trust and professional execution.</p><div className="mt-9 border-l border-accent pl-5"><p className="text-sm font-medium">Arch. Yunusa Ibrahim Hassan, MNIA</p><p className="mt-1 text-[9px] uppercase tracking-[.16em] text-muted-foreground">Founder & Chief Executive Officer</p></div></div></div></section>
